...
//defines
#define SSID_REDE     "miguer_broker"  //coloque aqui o nome da rede que se deseja conectar
#define SENHA_REDE    "broker777"  //coloque aqui a senha da rede que se deseja conectar
...
#define TOPICO_SUBSCRIBE "MQTTFFPlanta_Send_Miguer"     //tópico MQTT de escuta
#define TOPICO_PUBLISH   "MQTTFFPlanta_Recive_Miguer"    //tópico MQTT de envio de informações para Broker
                                                  //IMPORTANTE: recomendamos fortemente alterar os nomes
                                                  //            desses tópicos. Caso contrário, há grandes
                                                  //            chances de você controlar e monitorar o NodeMCU
                                                  //            de outra pessoa.
#define ID_MQTT  "planta_regg"     //id mqtt (para identificação de sessão)
...
PubSubClient MQTT(clientMQTT); // I nstancia o Cliente MQTT passando o objeto clientMQTT
