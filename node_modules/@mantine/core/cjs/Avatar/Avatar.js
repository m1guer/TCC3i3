...
const _Avatar = React.forwardRef((props, ref) => {
  ...
  const { classes, cx } = Avatar_styles['default']({ color, radius, size, withinGroup: ctx.withinGroup, spacing: ctx.spacing }, { classNames, styles: styles$1, unstyled, name: "Avatar" });
  React.useEffect(() => {
