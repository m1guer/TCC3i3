...
const _ColorSwatch = React.forwardRef((props, ref) => {
  const _a = styles.useComponentDefaultProps("ColorSwatch", defaultProps, props), { color, size, radius, className, children, classNames, styles: styles$1, unstyled } = _a, others = __objRest(_a, ["color", "size", "radius", "className", "children", "classNames", "styles", "unstyled"]);
  const { classes, cx } = ColorSwatch_styles['default']({ radius, size }, { classNames, styles: styles$1, unstyled, name: "ColorSwatch" });
