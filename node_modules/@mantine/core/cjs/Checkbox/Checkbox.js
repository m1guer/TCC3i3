...
const Checkbox = React.forwardRef((props, ref) => {
  ...
  const { classes, cx } = Checkbox_styles['default']({ size: (ctx == null ? void 0 : ctx.size) || size, radius, color, transitionDuration }, { name: "Checkbox", classNames, styles: styles$1, unstyled });
