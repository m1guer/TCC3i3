...
const List = React.forwardRef((props, ref) => {
  ...
  const { classes, cx } = List_styles['default']({ withPadding, size, listStyleType }, { classNames, styles: styles$1, name: "List", unstyled });
  return /* @__PURE__ */ React__default.createElement(styles.StylesApiProvider, {
    classNames,
    styles: styles$1,
    unstyled
  }, /* @__PURE__ */ React__default.createElement(List_context.ListContext.Provider, {
    value: { spacing, center, icon }
