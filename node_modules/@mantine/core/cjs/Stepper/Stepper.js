...
const Stepper = React.forwardRef((props, ref) => {
  ...
  const { classes, cx } = Stepper_styles['default']({ contentPadding, color, orientation, iconPosition, size, iconSize, breakpoint }, { classNames, styles: styles$1, unstyled, name: "Stepper" });
