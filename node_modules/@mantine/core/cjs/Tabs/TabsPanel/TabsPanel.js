...
const TabsPanel = React.forwardRef((_a, ref) => {
  var _b = _a, { value, children, sx, className } = _b, others = __objRest(_b, ["value", "children", "sx", "className"]);
  ...
  return /* @__PURE__ */ React__default.createElement(Box.Box, __spreadProps(__spreadValues({}, others), {
    ref,
    sx: [{ display: ctx.value !== value ? "none" : void 0 }, ...utils.packSx(sx)],
