...
function useTooltip(settings) {
  ...
  const { x, y, reference, floating, context, refs, update, placement } = reactDomInteractions.useFloating({
    placement: settings.position,
    open: opened,
    onOpenChange: onChange,
    middleware: [reactDomInteractions.offset(settings.offset), reactDomInteractions.shift({ padding: 8 }), reactDomInteractions.flip()]
  });
