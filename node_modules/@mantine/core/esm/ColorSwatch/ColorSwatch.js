...
const _ColorSwatch = forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("ColorSwatch", defaultProps, props), { color, size, radius, className, children, classNames, styles, unstyled } = _a, others = __objRest(_a, ["color", "size", "radius", "className", "children", "classNames", "styles", "unstyled"]);
