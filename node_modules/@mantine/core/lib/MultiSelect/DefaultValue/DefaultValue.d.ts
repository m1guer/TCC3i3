...
export declare function DefaultValue({ label, classNames, styles, className, onRemove, disabled, readOnly, size, radius, ...others }: MultiSelectValueProps): JSX.Element;
