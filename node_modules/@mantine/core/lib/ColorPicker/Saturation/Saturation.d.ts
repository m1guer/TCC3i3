...
export declare function Saturation({ value, onChange, focusable, __staticSelector, size, color, saturationLabel, classNames, styles, unstyled, }: SaturationProps): JSX.Element;
