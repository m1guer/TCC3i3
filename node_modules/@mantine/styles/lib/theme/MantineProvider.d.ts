...
export declare function useMantineProviderStyles(component: string | string[]): {
    styles: Record<string, import("..").CSSObject> | ((theme: MantineTheme, params: any) => Record<string, import("..").CSSObject>);
    classNames: Record<string, string>;
}[];
export declare function useMantineEmotionCache(): EmotionCache;
export declare function useComponentDefaultProps<T extends Record<string, any>>(component: string, defaultProps: Partial<T>, props: T): T;
